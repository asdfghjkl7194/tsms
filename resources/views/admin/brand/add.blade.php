					...
					<div class="page-content">
							<div class="row">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" name="brand_name" placeholder="商品名" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-2" name="brand_url" placeholder="地址" class="col-xs-10 col-sm-5" />
										</div>
									</div>
